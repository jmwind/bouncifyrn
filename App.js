    ...
    return (
      <GameEngine
        ...
        entities={{
          ...
          box23: {row: 1, col: 3, hits: 145, renderer: <BoxTile />}, 
          ...
          box15: {row: 3, col: 6, hits: 1, renderer: <BoxTile />},  
          box16: {row: 4, col: 7, hits: 99, renderer: <BoxTile />},  
          box17: {row: 1, col: 2, hits: 44, renderer: <BoxTile />},  
          box18: {row: 2, col: 6, hits: 33, renderer: <BoxTile />},  
          box19: {row: 6, col: 7, hits: 22, renderer: <BoxTile />},    
