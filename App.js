    ...
    return (
      <GameEngine
        ...
        entities={{
          ...
          box6: {row: 5, col: 0, hits: 2, renderer: <BoxTile />}, 
          box7: {row: 6, col: 0, hits: 4, renderer: <BoxTile />},
          box8: {row: 6, col: 1, hits: 4, renderer: <BoxTile />},  
          box9: {row: 6, col: 2, hits: 1, renderer: <BoxTile />},  
          box10: {row: 6, col: 3, hits: 1, renderer: <BoxTile />},  
          box13: {row: 6, col: 6, hits: 11, renderer: <BoxTile />},  
          box14: {row: 6, col: 7, hits: 34, renderer: <BoxTile />},    
