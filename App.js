  ...
  render() {
    return (
      <GameEngine
        ...
        entities={{
          ball: { type: "ball", state: "stopped", start: [200, ball_start], position: [200,  ball_start], speed: [3.0, 1.0], direction: [1,1], renderer: <Ball />},
          floor: { height: 125, ball_start: ball_start, renderer: <Floor /> },
          scorebar: {height: 90, best: 276, balls: 1, score: 0, renderer: <ScoreBar />},
          aimline: { start: [200, ball_start], end: [100, ball_start - 100], visible: "true", renderer: <AimLine />}           
        }}>
      </GameEngine>
    );
  }
