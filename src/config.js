export var Config = {
  ...
  MOVING: 100, // ball is moving
  STOPPED: 200, // ball has stopped
  PAUSED: 300, // game has started, but balls can't start yet (eg dialog, message)
  STARTED: 400, // game has started
};
